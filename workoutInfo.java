...
public class workoutInfo {
    ...
    // Method to read the previously logged workout from the file, individual methods for PR and non-PR used when user enters a new log.
    public String readWorkoutFromFile(String prStatus, String dateOfWorkout, String workoutName) {
        ...
        try {
            ...
            while (line != null) {
                ...
                if(workoutData[0].equals(prStatus) && workoutData[1].equals("Date: " + dateOfWorkout) && workoutData[2].equals("Workout Name: " + workoutName)) {
                    workoutDetails = line;
                    break;
                }
            }
    ...
    public String readPRWorkoutFromFile(String prStatus, String dateOfWorkout, String workoutName) {
        String workoutDetails = "";
        try {
            File file = new File("WorkoutHistory.txt");
            FileReader fr = new FileReader(file.getName());
    ...
    public String readNonPRWorkoutFromFile(String prStatus, String dateOfWorkout, String workoutName) {
        String workoutDetails = "";
        try {
            File file = new File("WorkoutHistory.txt");
            FileReader fr = new FileReader(file.getName());
    ...
    // increase in PR weight (and reps if necessary)
